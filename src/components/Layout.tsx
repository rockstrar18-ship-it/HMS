        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1 custom-scrollbar">
          {menuItems.map((item) => (
            ...
            >
              ...
              {activeTab === item.id && <div className="ml-auto w-1.5 h-1.5 rounded-full bg-emerald-600"></div>}
            </button>
          ))}
        </nav>

        <div className="p-4 border-t border-slate-100">
          <button className="w-full flex items-center space-x-3 px-4 py-2.5 rounded-xl text-slate-500 hover:bg-red-50 hover:text-red-600 transition-all duration-200">
            <LogOut size={18} />
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed top-0 left-0 bottom-0 w-72 bg-white z-50 p-6 shadow-2xl"
            >
